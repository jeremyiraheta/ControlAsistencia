<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeFile="Ubicaciones.aspx.cs" Inherits="Ubicaciones" %>
        ...
        <div class="row">
            <asp:Table ID="tblemp" CssClass="table table-dark table-hover" runat="server" >
                <asp:TableHeaderRow runat="server">
                    ...
                    <asp:TableHeaderCell>UBICACION INICIAL</asp:TableHeaderCell>
                    <asp:TableHeaderCell>UBICACION FINAL</asp:TableHeaderCell>
                    
                    <asp:TableHeaderCell><asp:Image ImageUrl="~/images/icons/ie.svg" runat="server" Width="20px" Height="20px" ToolTip="Mapa" /></asp:TableHeaderCell>
                     <asp:TableHeaderCell><asp:Image ImageUrl="~/images/icons/ie.svg" runat="server" Width="20px" Height="20px" ToolTip="Mapa" /></asp:TableHeaderCell>
